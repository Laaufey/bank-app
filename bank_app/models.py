   ...
   def externalTransfer(cls, amount, debit_account, debit_text, credit_account, credit_text, transaction_id):
      ...
      with transaction.atomic():
         if debit_account.money >= amount or debit_account.title == "OPS Bank Account":
            ...
            cls(amount=-amount, transaction_id=transaction_id, account=debit_account, text=debit_text,).save()
            cls(amount=amount, transaction_id=transaction_id, account=credit_account, text=credit_text).save()
